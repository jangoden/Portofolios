<template>
  <main
    ...
    <div class="space-y-2 text-center md:text-left px-10">
      ...
      <h1 class="text-4xl font-bold md:text-5xl text-white fadein-up">Deni Rahman</h1>
      <div class="py-2">
        <h1
...
export default {
  ...
  data() {
    return {
      toRotate: ["Web Developer", "Full-stack Engineer", "Informatics Student", "Tech Enthusiast", "Tukang Sare"],
      period: 2000,
      txt: '',
      loopNum: 0,
      isDeleting: false,
