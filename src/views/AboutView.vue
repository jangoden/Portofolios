...
<template>
  <div class="bg-[#1e1e1f] px-5 py-5 md:px-12 md:py-10 text-left border border-[#383838] rounded-3xl text-amber-50 mx-3 mb-5">
    ...
    <img
      ...
      height="300"
      decoding="async"
      class="w-[250px] h-[250px] object-cover rounded-full border-4 border-amber-200"
      :src="require('@/assets/akuu.jpg')"
      loading="lazy"
    />
  </div>
        <div class="md:w-7/12">
          <p class="mb-3 md:mb-7 fadein-left fadeins-1">
            <DecryptedText text="Hi everyone! My name is Deni Rahman. I'm a web developer from Ciamis, West Java. I have 1 year of experience in web development. I really enjoy what I do right now, in my opinion, creating programs is not just a job, but also an art that has aesthetic value." />
          </p>
          <p class="mb-3 fadein-left fadeins-2">
            <DecryptedText text="My job is to build your website to be functional and user-friendly yet still attractive. In addition, I provide a personal touch to your product and ensure that the website catches attention and is easy to use. My goal is to convey your message and identity in the most creative way. If you are interested in hiring me, please contact the listed contact." />
          </p>
        </div>
      </section>
    </article>
  ...
  <div class="px-5 py-5 md:px-12 md:py-10 text-left text-amber-50 mx-3">
    <article data-page="about">
      <header>
        <div class="text-2xl font-bold text-white mb-5 fadein-bot title-section flex items-center">
          <div class="h-[1px] w-10 bg-amber-200 md:w-20" data-aos="zoom-in-left" data-aos-duration="600"></div>
          ...
          <ul class="flex flex-wrap text-sm font-medium text-center text-gray-500 dark:text-gray-400 mb-5">
            ...
            <li class="mr-2">
              <button class="inline-block px-4 py-3 rounded-lg hover:text-white"
                ...
                @click="activeTab = 2">
                <DecryptedText text="Tools" />
              </button>
            </li>
          </ul>
        </div>
        <div v-show="activeTab === 1">
          <div class="grid grid-cols-2 gap-4 pb-32 md:grid-cols-3 xl:grid-cols-4 2xl:gap-12">
            <div v-for="item in tech" :key="item.id">
              <div class="item-tech flex cursor-pointer items-center gap-2 rounded border border-amber-200 px-2 py-2 hover:bg-amber-200 hover:bg-opacity-10">
                ...
                <div class="flex items-center text-sm md:text-base lg:text-lg">
                  ...
                  <div class="status-tech opacity-0 absolute mt-5 text-[10px] text-amber-200 transition-all duration-300 md:text-xs lg:text-sm">
                    <DecryptedText :text="item.status" />
                  </div>
                </div>
              </div>
            </div>
